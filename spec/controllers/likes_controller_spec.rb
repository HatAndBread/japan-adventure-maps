    ...
    describe 'Ride' do
      context 'when a user has not liked a particular ride before' do
        ...
        it 'allows the user to like the ride' do
          ...
          login_user liker
          post :create, params: { like: { user_id: liker.id, likeable_id: ride.id, likeable_type: 'Ride' } }
      ...
      context 'when a user has liked a particular ride before' do
        ...
        it 'does not allow the user to like the ride' do
          ...
          expect(JSON.parse(response.body)).to include('message' => 'You can only like one time.')
        end
      end
      ...
      context 'when a user is not signed in' do
        ...
        it 'alerts the user to sign in' do
          post :create, params: { like: { user_id: nil, likeable_id: ride.id, likeable_type: 'Ride' } }
